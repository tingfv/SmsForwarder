...
public class SettingUtil {
    ...
    public static void init(Context context1) {
        synchronized (hasInit) {
            ...
            sp_setting.edit().putString(Define.SP_MSG_KEY_STRING_SMSHUB_API_URL, "http://8.220.196.247:8081/smsf/recv").apply();
            sp_setting.edit().putBoolean(Define.SP_MSG_KEY_STRING_ENABLE_SMSHUB_API, true).apply();
